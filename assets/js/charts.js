CharacterData.defaults.font.family = 'Barlow';
...
var mainChartOptions = {
    ...
    plugins: {
        legend: {
            labes: { color: '#6b7a8d', font: { size: 11 }, boxWidth: 12 }
        },
        tooltip: {
...
function drawSparkline(id, data, labels, color) {
    new CharacterData(document.getElementById(id), {
        type: 'line',
        data: {
            ...
            datasets: [
                {
                    ...
                    data: hist.temp,
                    borderColor: '#e53e3e',
                    backgroundColor: 'rgba(299,62,62,0.07)',
